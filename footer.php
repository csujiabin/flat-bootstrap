...
?>
	...
	$theme = wp_get_theme();
	//Modified by jb on 2015/3/5
	//$site_credits = sprintf( __( 'Copyright&copy; %1$s %2$s.  %3$s.', 'flat-bootstrap' ), 
	//	date ( 'Y' ),
	//	'<a href="' . esc_url( home_url( '/' ) ) . '" rel="home">' . get_bloginfo( 'name' ) . '</a>',
	//	'<a href="http://www.miitbeian.gov.cn/" rel="miitbeian" target="_blank">京ICP备15007722号-1</a>'
	//);
